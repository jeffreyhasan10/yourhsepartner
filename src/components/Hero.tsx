...
const Hero = () => {
  ...
  return (
    <section className="overflow-hidden relative bg-gradient-to-br from-ehs-50 via-white to-ehs-100" id="hero" style={{
      padding: isMobile ? '100px 12px 60px' : '120px 20px 80px'
    }}>
      {/* Enhanced Background Elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-ehs-gradient opacity-20 blur-3xl rounded-full animate-pulse-slow"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-primary-gradient opacity-15 blur-2xl rounded-full animate-float"></div>
      <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-ehs-200 opacity-10 blur-xl rounded-full"></div>
      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            <h1 className="section-title text-4xl sm:text-5xl lg:text-6xl xl:text-7xl leading-tight opacity-0 animate-fade-in font-display" style={{
              animationDelay: "0.3s"
            }}>
            ...
            <p style={{
              animationDelay: "0.5s"
            }} className="section-subtitle mt-6 mb-8 leading-relaxed opacity-0 animate-fade-in text-gray-700 font-normal text-lg sm:text-xl text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 opacity-0 animate-fade-in" style={{
              animationDelay: "0.6s"
            }}>
              {stats.map((stat, index) => (
                <div key={index} className="stats-card text-center hover:shadow-md transition-all duration-300 hover:scale-105">
            ...
            <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in" style={{
              ...
              <a href="#features" className="button-primary flex items-center justify-center group w-full sm:w-auto text-center">
                Explore Our Solutions
                <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </a>
              <a href="#demo" className="button-secondary flex items-center justify-center w-full sm:w-auto text-center group">
            ...
            <div className="mt-8 opacity-0 animate-fade-in" style={{
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-600">
                <div className="flex items-center">
                  ...
                  <span>ISO 14001 & 45001 Compliant</span>
                </div>
                <div className="flex items-center">
          ...
          <div className="w-full lg:w-1/2 relative mt-8 lg:mt-0">
            {lottieData ? (
              ...
              <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-3xl shadow-ehs-shadow group">
