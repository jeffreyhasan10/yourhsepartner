...
const Hero = () => {
  ...
  return <section className="overflow-hidden relative bg-gradient-to-br from-ehs-50 via-white to-ehs-100" id="hero" style={{
      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            {/* Stats Section */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 sm:mb-8 opacity-0 animate-fade-in" style={{
            animationDelay: "0.6s"
          }}>
              {stats.map((stat, index) => <div key={index} className="stats-card text-center">
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            ...
            animationDelay: "0.9s"
                ...
                <LottieAnimation animationPath={lottieData} className="w-full h-auto max-w-lg mx-auto relative z-10" loop={true} autoplay={true} />
              </div> : <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-ehs-shadow">
                <div className="absolute inset-0 bg-primary-gradient rounded-2xl sm:rounded-3xl -z-10 opacity-20"></div>
                <img ref={imageRef} alt="EHS Management Dashboard" style={{
              transformStyle: 'preserve-3d'
            }} className="w-full h-auto transition-transform duration-500 ease-out object-fill" src="/lovable-uploads/bd8cb36b-ea77-4f07-a211-3d2857f02339.png" />
              </div>}
          </div>
        </div>
      </div>
